...
public class StatutRapprochementConverter extends GenericConverter implements Converter {
	...
	public StatutRapprochementConverter() {
	...
	/*** Récupération de la typologie du statut ventilation ***/
	public void appelServiceListerTypologie() {
		...
		ReponseService<List<Typologie>> reponse = typologieService.listerTypologie("StatutRapprochement", getContexteCedicam());
