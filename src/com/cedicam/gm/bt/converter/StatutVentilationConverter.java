...
public class StatutVentilationConverter extends GenericConverter implements Converter {
	...
	public StatutVentilationConverter() {
	...
	public void appelServiceListerTypologie() {
		...
		ReponseService<List<Typologie>> reponse = typologieService.listerTypologie("StatutVentilation", getContexteCedicam());
