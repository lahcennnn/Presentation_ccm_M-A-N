...
public class PuitConverter extends GenericConverter implements Converter {
	...
	public void appelServiceListerTypologie() {
		...
		ReponseService<List<Typologie>> reponse = typologieService.listerTypologie("Puit", getContexteCedicam());
