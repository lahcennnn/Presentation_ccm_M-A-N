...
public class HeureValidator implements Validator {
	...
	public void validate(FacesContext arg0, UIComponent arg1, Object arg2)
		...
		if (arg2 != null) {
			String heureStr = "" + arg2;
			if (FormValidationUtil.empty(heureStr)) {
				errorDescription = FormValidationUtil.ERROR_EMPTY;
				success = false;
			} else if (!FormValidationUtil.isHHMM(heureStr)) {
				errorDescription = FormValidationUtil.ERROR_HEURE_FORMAT;
				success = false;
			}
		}
		if (!success) {
